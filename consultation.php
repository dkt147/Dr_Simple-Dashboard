                ...
                <table>
                    ...
                    if(isset($_POST['searchbtn']) && !empty($_POST['searchproduct']))
                    {
                        ...
                        $query = "SELECT 
                                    ...
                                    patient.name,
                                    patient.is_active,
                                    appointment.id as a_id,appointment.type,appointment.date,appointment.is_completed,appointment.is_confirm,    
                    ...
                    if (mysqli_num_rows($res) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($res)) {
                            $c = $c + 1;
                            ?>
                            <tr onclick="location.href = 'subpage2.php?id=<?php echo $row['a_id'] ?>';">
