                    ...
                    if (mysqli_num_rows($res) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($res)) {
                            ...
                            <tr >
                                ...
                                <td class="table1SecondColumn" onclick="location.href = 'subpage4.php?id=<?php echo $row['a_id'] ?>';">
                                    <p><?php echo $row['name'] ?>
                                ...
                                <td class="table1ThirdColumn" onclick="location.href = 'subpage4.php?id=<?php echo $row['a_id'] ?>';">
                                    <p><?php echo "Regulärer Termin Anfrage" ?></p>
                                </td>
                                <td class="table1ForthColumn" onclick="location.href = 'subpage4.php?id=<?php echo $row['a_id'] ?>';">
                                    <?php
                                ...
                                <td class="table1FifthColumn" onclick="location.href = 'subpage4.php?id=<?php echo $row['a_id'] ?>';">
