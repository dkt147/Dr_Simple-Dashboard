    ...
    <section class="dashboardAbsoluteSection">
        ...
        <main>
            <section class="dashboardTitleSection">
                ...
                <div style="margin-left: 160px;"><p>Recipe</p></div>
                <div style="margin-left: 255px;"><p>Status</p></div>
            ...
            <section class="dashboardTableContent1">
                <table>
                    ...
                    if(isset($_POST['searchbtn']) && !empty($_POST['searchproduct']))
                    {
                        ...
                        $query = "SELECT * FROM `recipe` where type = '$name' order by id desc";
                        ...
                        $query = "SELECT 
                                    ...
                                    order.id as o_id,order.power,order.u_id,order.r_id,order.is_completed,order.is_confirm,    
                                    order.date
                                    FROM `order`
                                    JOIN patient
                    ...
                    if (mysqli_num_rows($res) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($res)) {
                            ?>
                            <tr onclick="location.href = 'subpage1.php?id=<?php echo $row['o_id'] ?>';">
